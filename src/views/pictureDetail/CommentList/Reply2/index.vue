<template>
	<div>
		<div class="flex">
			...
			<div class="content flex-1 pr-16">
				<p class="color-#656565 text-18 font-600" v-user="data.postUserId">
					{{ data.nickname }}
				</p>
				<p class="color-##434343 text-14 lh-19.07" style="line-break: anywhere">
					{{ data.postContent }}
		...
		<Reply3
			class="ml-16 my-8"
			v-for="(vo, index) in props.children"
			:data="vo"
			:key="index"
			@refresh="onRefresh"
		/>
...
<script setup>
	...
	import Reply3 from '../Reply3/index.vue'
