	...
	>
		<div class="option-dialog">
			<div class="buttons">
				...
				>
					<!-- <img
						src="../../common/assets/img/icon/components/video/download-gray.png"
						alt=""
					/> -->
				...
				<template v-if="canDownload">
					<dy-button type="green" v-if="showShare2WeChatZone" @click="_no">
						<template v-slot:prefix>
							<!-- <img
								src="../../common/assets/img/icon/components/video/wechatzone-white.webp"
								alt=""
							/> -->
						</template>
						发送视频到朋友圈
					...
					<dy-button type="green" v-if="showShare2WeChat" @click="_no">
						<template v-slot:prefix>
							<!-- <img
								src="../../common/assets/img/icon/components/video/wechat-white.webp"
								alt=""
							/> -->
						</template>
						发送视频到微信
					...
					<dy-button type="qqzone" v-if="showShare2QQZone" @click="_no">
						<template v-slot:prefix>
							<!-- <img
								src="../../common/assets/img/icon/components/video/qqzone-white.png"
								alt=""
							/> -->
						</template>
						发送视频到QQ空间
					...
					<dy-button type="qq" v-if="showShare2QQ" @click="_no">
						<template v-slot:prefix>
							<!-- <img
								src="../../common/assets/img/icon/components/video/qq-white.webp"
								alt=""
							/> -->
						</template>
						发送视频到QQ
					...
					<dy-button type="webo" v-if="showShare2Webo" @click="_no">
						<template v-slot:prefix>
							<!-- <img
								src="../../common/assets/img/icon/components/video/webo-white.webp"
								alt=""
							/> -->
						</template>
						发送视频到微博
				...
				<template v-if="showDownload">
					...
					<dy-button class="mt1r" type="white" @click="_no">
						<!-- <img
							src="../../common/assets/img/icon/components/video/wechat.webp"
							alt=""
						/> -->
						发送视频到微信
					</dy-button>
			...
			<div class="dialog-friends">
				...
				<div
					class="more"
					@click="cancel($router.push('/message/share-to-friend'))"
				>
					<!-- <img
						src="../../common/assets/img/icon/components/video/more-dark.png"
					/> -->
					<div class="right">
						<span>更多好友</span>
					</div>
