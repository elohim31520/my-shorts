<template>
	<div class="Search">
		<div class="header">
			<dy-back mode="light" class="mr1r"></dy-back>
			<Search
		...
		<div class="content">
			<div class="history">
				<div class="row" :key="index" v-for="(item, index) in lHistory">
					<div class="left">
						<img src="/shorts/img/icon/home/time-white.png" alt="" />
						<span>{{ item }}</span>
					</div>
					<dy-back
						img="close"
			...
			<div class="guess">
				<div class="title">
					...
					<div class="right" @click.stop="refresh">
						<img class="scan" src="/shorts/img/icon/home/refresh-gray.png" />
						<span>换一换</span>
					</div>
				</div>
				<div class="keys">
					...
					>
						...
						<img
							v-if="item.type === 1"
							src="/shorts/img/icon/home/new.webp"
							alt=""
							class="type"
						/>
					</div>
						...
						<div class="slide0" ref="slide0">
							<div class="l-row">
								<div class="rank-wrapper">
									<img
										src="/shorts/img/icon/home/to-top-yellow.png"
										class="rank"
									/>
								</div>
								<div class="right">
							...
							<div
								class="l-row"
								:key="index"
								v-for="(item, index) in data.hotRankList"
							>
								<div class="rank-wrapper">
									<img
										v-if="index === 0"
										src="/shorts/img/icon/home/hot1.webp"
										alt=""
										class="rank"
									/>
									<img
										v-else-if="index === 1"
										src="/shorts/img/icon/home/hot2.webp"
										alt=""
										class="rank"
									/>
									<img
										v-else-if="index === 2"
										src="/shorts/img/icon/home/hot3.webp"
										alt=""
										class="rank"
									/>
								...
								<div class="right">
									<div class="center">
										...
										<img
											v-if="item.type === 0"
											src="/shorts/img/icon/home/hot.webp"
											alt=""
											class="type"
										/>
									</div>
					...
					<SlideItem>
						<div class="slide1" ref="slide1">
							<div
								class="l-row"
								:key="index"
								v-for="(item, index) in data.liveRankList"
							>
								<div class="rank-wrapper">
								...
								<div class="right">
									<div class="center">
										<div class="avatar-wrapper">
											<img
												src="/shorts/img/icon/avatar/1.png"
												alt=""
												class="avatar"
											/>
										</div>
										...
										<div v-if="item.type === 0" class="live-type">
											<img class="type1" src="/shorts/img/icon/home/pk.webp" />
											<span>PK</span>
										</div>
										<div v-if="item.type === 1" class="live-type">
											<img
												class="type2"
												src="/shorts/img/icon/home/redpack.png"
											/>
											<span>红包</span>
										</div>
									</div>
						...
						<div class="slide2" ref="slide2">
							...
							>
								...
								<div class="right">
									...
									<div class="count">
										<img src="/shorts/img/icon/home/hot-gray.png" alt="" />
		...
		musicRankList: [
			{
				...
				cover: new URL('/shorts/img/music-cover/1.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 99,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/2.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/3.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/4.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/5.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/6.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/7.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/8.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/9.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/10.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/11.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/12.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/18.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/14.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/15.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/16.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
			...
			},
			{
				...
				cover: new URL('/shorts/img/music-cover/17.jpg', import.meta.url).href,
				author: '周杰伦',
				duration: 60,
				use_count: 37441000,
				is_collect: false,
